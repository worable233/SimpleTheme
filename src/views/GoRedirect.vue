...
<template>
  <section class="flex min-h-screen items-center justify-center px-4 py-8">
    ...
    <div v-if="!route.query.url" class="flex w-full max-w-[440px] flex-1 flex-col items-center justify-center text-center">
      ...
      <p class="mb-5 text-sm leading-relaxed text-secondary">缺少前往地址。</p>
    ...
    <div v-else class="flex w-full max-w-[440px] flex-1 flex-col items-center justify-center text-center">
      <div class="mb-6 w-full max-w-[300px]">
      ...
      <div class="mb-3 flex w-full items-center gap-2 rounded-xl border border-border bg-muted px-4 py-3 text-left text-sm break-all text-foreground">
        <svg class="shrink-0 text-secondary" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" width="16" height="16">
